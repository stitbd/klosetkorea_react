...
const SearchIcon = () => (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z" /></svg>);

const CartIcon = () => (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9m5-9v9m4-9v9m5-9l2 9" /></svg>);

const UserIcon = () => (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0zm-4 7a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7z" /></svg>);
          ...
          <ul className="flex items-center">
            ...
            {NAV_LINKS.map((menu) => (
              ...
              <li key={menu.label} className="relative group">
                ...
                <Link
                  to={menu.href}
                  className="flex items-center px-5 py-3 text-sm font-medium text-gray-700 hover:text-red-600"
                >
                  {menu.label}
                  {menu.children && <ChevronDownIcon/>}
                </Link>
                ...
                {menu.children && (
                  ...
                  <div className="absolute left-0 top-full bg-white shadow-lg hidden group-hover:block min-w-[220px]">
                    ...
                    <ul className="py-2">
                      ...
                      {menu.children.map((child) => (
                        ...
                        <li key={child.label} className="relative group/sub">
                          ...
                          >
                            {child.label}
                            {child.children && <ChevronDownIcon/>}
                          </Link>
                          ...
                          {child.children && (
                            ...
                            <div className="absolute left-full top-0 bg-white shadow-lg hidden group-hover/sub:block min-w-[200px]">
